...
ROW_INDEX = 17 # Change this for each scraper
def main(roster_row):
    try:
        """
        Avoid Jailtracker if possible;
        
        OLD URL: http://www.jailtracker.com/marshallcounty/marshall_inmatelist.html
        NEW URL: http://mcagis.org/inmates
        JAB 2020-04-05 -> Note this all forwards now to: https://www.marshallso.org/roster.php
        """
        ...
        assert roster_row['County'].lower() == 'marshall'
        pages = []
        page_index = 0
        time.sleep(np.random.uniform(5,10,1))    	    
        dropdown = browser.find_element_by_xpath('//*[@id="gvInmates_DXPagerBottom_PSI"]')
        dropdown.click()
