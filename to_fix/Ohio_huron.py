...
ROW_INDEX = 749 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        """
        Looks like page redicrects you to : http://24.142.144.46:8080/TDT_Viewer/actions/FilterInmateInformation.do with a different setup
        """
        ...
        #Open roster in new tab
        roster_link = browser.find_element_by_xpath('//*[@id="content"]/div[2]/p/strong/a')
        roster_link.click()
        
        #Wait
        time.sleep(np.random.uniform(3,6,1))
        
        #Close current tab, switch to newly opened tab
        browser.close()
