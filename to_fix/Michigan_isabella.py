...
ROW_INDEX = 419 # Change this for each scraper
def main(roster_row):
    try:
        ...
        assert roster_row['County'].lower() == 'isabella'
        ...
        while lastpage == False:
            ...
            # TODO: fix this xpath. This looks like what it looks like
            # when you browse there, but this element doesn't seem to
            # work
