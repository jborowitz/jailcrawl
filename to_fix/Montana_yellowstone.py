...
ROW_INDEX = 588 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        menu = browser.find_element_by_xpath('/html/body/div/div[7]/div[2]/form/center/select')
        menu.send_keys('e')
        
        #Wait
        time.sleep(np.random.uniform(0.5,1.5,1))
        
        search = browser.find_element_by_xpath('/html/body/div/div[7]/div[2]/form/center/input[2]')
        search.click()
