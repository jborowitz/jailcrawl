...
ROW_INDEX = 697 # Change this for each scraper. This references the row
...
THIS_COUNTY = 'columbus'
def main(roster_row):
    try:
        logger = get_logger(roster_row) # Get a standard logger
        '''
        Here there is a pdf viewable in a frame, which doesn't load in the HTML DOM
        '''
