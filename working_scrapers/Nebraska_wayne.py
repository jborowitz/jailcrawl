...
ROW_INDEX = 601 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        crawlers.save_single_page(roster_row, filetype='xls') # try to call a known crawler if possible
