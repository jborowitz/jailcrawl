...
ROW_INDEX = 901 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        crawlers.basic_multipage(roster_row, next_type='id', next_string='next') # try to call a known crawler if possible
