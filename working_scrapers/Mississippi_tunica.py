...
ROW_INDEX = 515 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        crawlers.roster_php(roster_row, num_per_page=10) # try to call a known crawler if possible
