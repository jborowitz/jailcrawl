...
ROW_INDEX = 370 # Change this for each scraper
def main(roster_row):
    try:
        ...
        assert roster_row['County'].lower() == 'avoyelles'
        
        """This agency is providing this roster of incarcerated offenders
        to the public and law enforcement in the interest of public safety.
        This information shall not be considered, or used as, a public
        document, or official document, and no other publication or copying of
        this information is allowed without the express written consent of
        this agency. Any unauthorized use of this information is forbidden and
