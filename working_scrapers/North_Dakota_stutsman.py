...
ROW_INDEX = 724 # Change this for each scraper. This references the row
# of the main jailcrawl spreadsheet. This index will be used to look up
# the URL as well as state/county info
THIS_STATE = 'north dakota' # Change the current state/county information. 
THIS_COUNTY = 'stutsman'
def main(roster_row):
    try:
        """
        IFRAME SITE
        
        OLD: https://www.co.stutsman.nd.us/departments/correctional-center/roster/
        UPDATED: https://www.co.stutsman.nd.us/wordpress/vsweb/Roster-iFrame.aspx
        
        GREEN HIGHLIGHTING INDICATES LAST 24 HOURS
        """
