...
ROW_INDEX = 610 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        # Go to the full custody list
        time.sleep(np.random.uniform(5,10,1))
        elem = browser.find_element_by_partial_link_text("full custody list")
        elem.click()
        
        #Select "ALL" from custody list
        time.sleep(np.random.uniform(5,10,1))
        elem = browser.find_element_by_xpath('//*[@id="SubmitButton"]')
        elem.click()
