...
ROW_INDEX = 969 # Change this for each scraper. This references the row
# of the main jailcrawl spreadsheet. This index will be used to look up
# the URL as well as state/county info
THIS_STATE = 'washington' # Change the current state/county information. 
THIS_COUNTY = 'marysville'
def main(roster_row):
    try:
        ...
        crawlers.basic_multipage(roster_row, next_type="xpath", next_string='//*[@id="Inmate_Index"]/div[2]/div[3]/a[3]') # try to call a known crawler if possible
