...
ROW_INDEX = 821 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        logger.info('clicking i agree')
        agree = browser.find_element_by_xpath('/html/body/center/form/input')
        agree.click()
