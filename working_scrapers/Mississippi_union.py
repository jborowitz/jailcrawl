...
ROW_INDEX = 516 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        #append url with letter-specific suffix
        suffix = '?id={}'
        ...
        for letter in alphabet:
            ...
            req = requests.get(urlAddress+suffix.format(letter))
