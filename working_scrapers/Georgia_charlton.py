...
ROW_INDEX = 107 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        #Select institution (CHARLTON COUNTY JAIL)
        ...
        regex = re.compile("^CHARLTON COUNTY JAIL")
