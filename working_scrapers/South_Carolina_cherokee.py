...
ROW_INDEX = 851 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        crawlers.zuercher_crawler(roster_row) # try to call a known crawler if possible
