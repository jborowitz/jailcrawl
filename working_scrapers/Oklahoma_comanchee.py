...
ROW_INDEX = 786 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        #urlAddress = roster_row['Working Link'] # Set the main URL from the spreadshet
