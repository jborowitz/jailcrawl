...
ROW_INDEX = 95 # Change this for each scraper. This references the row
# of the main jailcrawl spreadsheet. This index will be used to look up
# the URL as well as state/county info
THIS_STATE = 'florida' # Change the current state/county information. 
THIS_COUNTY = 'gadsden'

"""IFRAME SITE:

OLD URL: http://69.21.72.195/smartwebclient/
NEW URL: http://69.21.72.195/smartwebclient/Jail.aspx
"""
...
def main(roster_row):
    try:
        ...
        crawlers.smartweb_crawler(roster_row) # try to call a known crawler if possible
