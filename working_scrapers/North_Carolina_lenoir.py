...
ROW_INDEX = 705 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        """
        This scraper formerly listed under "Kinston," which is a city, not a county.
        Kinston is in Lenoir county.

        Supplied link is for specific date only:
        https://www.kinston.com/assets/pdf/NC1565221.PDF
        
        Updated URL for Lenoir County:
        https://www.inmateaid.com/inmate-locator/lenoir-county-nc-we-billy-smith-detention-center.amp
        ...
        crawlers.inmate_aid(roster_row) # try to call a known crawler if possible
