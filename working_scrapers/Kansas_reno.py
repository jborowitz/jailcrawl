...
ROW_INDEX = 263 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        #Clicking show all
        elem = browser.find_element_by_xpath('//*[@id="recordspp1"]')
        elem.click()        
        time.sleep(np.random.uniform(1,2,1))
        
        elem = browser.find_element_by_xpath('//*[@id="recordspp1"]/option[7]')
        elem.click() 
        time.sleep(np.random.uniform(1,2,1))
