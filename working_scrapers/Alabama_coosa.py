...
ROW_INDEX = 7 # Change this for each scraper
def main(roster_row):
    try:
        """
        OLD URL: http://www.coosacountyso.org/inmate-roster
        NEW URL: http://71.12.97.246/dcn/
        ...
        assert roster_row['County'].lower() == 'coosa'

        time.sleep(np.random.uniform(5,10,1))
        view_all = browser.find_element_by_xpath('//*[@id="InmatesLink"]/h3')
        view_all.click()
