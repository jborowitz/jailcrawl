...
ROW_INDEX = 682 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        """
        Supplied URL is for general search of NY state prisons:
        http://nysdoccslookup.doccs.ny.gov/
        
        UPDATED URL:
        (COUNTY JAIL)
        https://www.inmateaid.com/inmate-locator/wyoming-county-ny-jail.amp
        """
