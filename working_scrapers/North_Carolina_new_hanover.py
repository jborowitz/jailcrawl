...
ROW_INDEX = 712 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        listbox = browser.find_element_by_xpath('//*[@id="pager_center"]/table/tbody/tr/td[5]/select')
        listbox.click()
