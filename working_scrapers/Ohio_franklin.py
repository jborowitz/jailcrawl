...
ROW_INDEX = 740 # Change this for each scraper. This references the row
...
THIS_COUNTY = 'franklin'
def main(roster_row):
    try:
        logger = get_logger(roster_row) # Get a standard logger
        """
        OLD URL: https://fcsojmsweb.franklincountyohio.gov/Publicview/(S(14knmnmsuo4boqb3t2l4aw0k))/BookingFind.aspx
        UPDATED URL: https://fcsojmsweb.franklincountyohio.gov/Publicview/BookingFind.aspx
        ...
        for letter in letters:
            ...
            time.sleep(np.random.uniform(1,3,1))
            search_button = browser.find_element_by_xpath('//*[@id="btnSearch"]')
            search_button.click()
            ...
            logger.info('Saved page for _%s_', letter)
