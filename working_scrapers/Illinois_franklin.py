...
ROW_INDEX = 175 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        # Clicking the arrest report
        elem = browser.find_element_by_xpath('//*[@id="node-417"]/div[1]/div[2]/div[2]/div/span/a')
        elem.click()     
        time.sleep(np.random.uniform(4,6,1))
        
        # Saving the arrest report
