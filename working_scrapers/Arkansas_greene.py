...
ROW_INDEX = 38 # Change this for each scraper
def main(roster_row):
    try:
        """
        INMATEAID SITE
        
        OLD URL: https://www.inmateaid.com/prisons/greene-county-ar-jail
        NEW URL: https://www.inmateaid.com/inmate-locator/greene-county-ar-jail.amp
        ...
        assert roster_row['County'].lower() == 'greene'
        ...
        for letter in letters:
            ...
            letters_pages.append(page_name)
