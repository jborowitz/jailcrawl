...
ROW_INDEX = 962 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        crawlers.basic_multipage(roster_row, next_type="xpath", next_string='//*[@id="JailRosterbuttondiv"]/a[8]') # try to call a known crawler if possible
