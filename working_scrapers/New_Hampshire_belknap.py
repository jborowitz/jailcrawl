...
ROW_INDEX = 605 # Change this for each scraper. This references the row
# of the main jailcrawl spreadsheet. This index will be used to look up
# the URL as well as state/county info
THIS_STATE = 'new hampshire' # Change the current state/county information. 
THIS_COUNTY = 'belknap'
def main(roster_row):
    try:
        """
