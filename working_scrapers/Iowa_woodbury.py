...
ROW_INDEX = 246 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        #Clicking show all
        elem = browser.find_element_by_xpath('//*[@id="ddDisplayRows"]')
        elem.click()
        time.sleep(np.random.uniform(1,2,1))
        
        elem = browser.find_element_by_xpath('//*[@id="ddDisplayRows"]/option[5]')
        elem.click()
