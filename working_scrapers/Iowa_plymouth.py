...
ROW_INDEX = 240 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
       ...
       #Pulling the specific link for the current inmate pdf and convert it to text
        ...
        website_df=website_df[website_df.link.str.contains("/plugins/show_image.php")]
        ...
        r = requests.get("http://plymouthcountysheriff.com/"+last_link)
