...
ROW_INDEX = 853 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        crawlers.basic_multipage(roster_row, next_type='class', next_string='dxWeb_pNext_Metropolis') # try to call a known crawler if possible
