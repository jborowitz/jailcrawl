...
ROW_INDEX = 606 # Change this for each scraper. This references the row
# of the main jailcrawl spreadsheet. This index will be used to look up
# the URL as well as state/county info
THIS_STATE = 'new jersey' # Change the current state/county information. 
THIS_COUNTY = 'bergen'
def main(roster_row):
    try:
        ...
        #Set up lists for stored pages, indices
        pages = []
        ...
        for letter in letters:
            ...
            lastname = browser.find_element_by_xpath('/html/body/form[2]/table[2]/tbody/tr[4]/td[3]/table/tbody/tr[3]/td[1]/table/tbody/tr/td/table/tbody/tr[2]/td/table/tbody/tr[2]/td[2]/input')
            lastname.send_keys(Keys.DELETE, Keys.BACKSPACE)
            lastname.send_keys(letter)
            
            time.sleep(np.random.uniform(1,2,1))

            searchbutton = browser.find_element_by_xpath('/html/body/form[2]/table[2]/tbody/tr[4]/td[3]/table/tbody/tr[3]/td[1]/table/tbody/tr/td/table/tbody/tr[3]/td/table/tbody/tr/td/a[1]/img')
            searchbutton.click()
            ...
            filename = letter+'_{}'.format(page_index)
            save_to_s3(store_source, filename, roster_row)
            logger.info('Saved page _%s_', filename)
            ...
            while not finished:
                try:
                    nextpage = browser.find_element_by_xpath('/html/body/table[2]/tbody/tr[4]/td[3]/table/tbody/tr[3]/td/table/tbody/tr/td/table/tbody/tr[4]/td/table/tbody/tr/td[5]/div/a')
                    nextpage.click()
                    page_index += 1
                    time.sleep(np.random.uniform(5,10,1))
                    store_source = browser.page_source
            ...
            back_to_search = browser.find_element_by_xpath('/html/body/map/area')
