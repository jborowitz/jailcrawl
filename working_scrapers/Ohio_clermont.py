...
ROW_INDEX = 733 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        details = browser.find_elements_by_link_text('Details')
        
        #Expand all "Details" blocks    
        for detail in details:
            detail.click()
            logger.info('clicking detail _%s_', str(detail))
