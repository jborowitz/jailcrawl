...
ROW_INDEX = 42 # Change this for each scraper
def main(roster_row):
    try:
        """
        Supplied URL had no roster
        
        OLD URL: https://www.johnsoncosheriff.com/roster.php
        UPDATED URL: https://www.myr2m.com/johnsoncoroster/
        ...
        assert roster_row['County'].lower() == 'johnson'
