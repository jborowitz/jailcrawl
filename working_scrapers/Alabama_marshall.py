...
ROW_INDEX = 17 # Change this for each scraper. This references the row
# of the main jailcrawl spreadsheet. This index will be used to look up
# the URL as well as state/county info
THIS_STATE = 'alabama' # Change the current state/county information. 
THIS_COUNTY = 'marshall'
def main(roster_row):
    try:
        ...
        crawlers.roster_php(roster_row) # try to call a known crawler if possible
