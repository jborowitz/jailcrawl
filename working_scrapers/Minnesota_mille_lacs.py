...
ROW_INDEX = 454 # Change this for each scraper
def main(roster_row):
    try:
        ...
        assert roster_row['County'].lower() == 'mille lacs'
        """
        OLD URL: http://www.co.mille-lacs.mn.us/jail
        
        NEW URL = http://136.234.73.241/
        """
