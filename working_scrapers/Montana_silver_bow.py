...
ROW_INDEX = 587 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        pdf_box = soup.find_all('ol', {'class':'semanticList bullets'})
        pdf_links = pdf_box[0].find_all('a', href=True)
        
        prefix = 'https://co.silverbow.mt.us/'
        suffix = pdf_links[0]['href']
