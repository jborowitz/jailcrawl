...
ROW_INDEX = 580 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        """
        OLD URL:https://www.falloncounty.net/sheriff/detentionCenter.html
        UPDATED URL: https://www.falloncounty.net/sheriff.html
