...
ROW_INDEX = 903 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        #crawlers.jailinmates_aspx(roster_row) # try to call a known crawler if possible
        crawlers.basic_multipage(roster_row, next_type='class', next_string='ui-icon ui-icon-seek-next') # try to call a known crawler if possible
