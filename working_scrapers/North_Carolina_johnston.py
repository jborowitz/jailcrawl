...
ROW_INDEX = 704 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        agree = browser.find_element_by_xpath('/html/body/div[1]/div[3]/div[3]/table/tbody/tr/td/form/div[3]/input')
        agree.click()
    	   
        #Wait
        time.sleep(np.random.uniform(2,3,1))
