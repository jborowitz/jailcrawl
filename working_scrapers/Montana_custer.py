...
ROW_INDEX = 577 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        pdf_link = sidebar.find('a', href=True)
        urlAddress2 = pdf_link['href']
        
        #Wait
        time.sleep(np.random.uniform(5,10,1))
        
        req2 = requests.get(urlAddress2)
