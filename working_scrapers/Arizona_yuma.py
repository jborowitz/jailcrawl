...
ROW_INDEX = 89 # Change this for each scraper. This references the row
# of the main jailcrawl spreadsheet. This index will be used to look up
# the URL as well as state/county info
THIS_STATE = 'arizona' # Change the current state/county information. 
THIS_COUNTY = 'yuma'
def main(roster_row):

    """
    There is no Yuma County, Colorado. It's in Arizona.
    State has been corrected.
    
    Supplied URL is for specific date in 2015.
    
    OLD URL: https://docs.google.com/file/d/0B0yN-as7CedNNlZJTkVUbGM3aTQ/edit
    NEW URL: http://inmatesearch.yumacountysheriff.org/NewWorld.Aegis.WebPortal/Corrections/InmateInquiry.aspx
    Updated URL: https://inmatesearch.yumacountysheriff.org/NewWorld.InmateInquiry/AZ0140000/
    """
