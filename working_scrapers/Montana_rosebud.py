...
ROW_INDEX = 586 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        navigation = soup.find_all('div', {'class':'department_sidebar col s12 l4'})
        pdf_links = navigation[0].find_all('a', href=True)
        inmates = pdf_links[1]['href']
        
        req2 = requests.get(inmates)
