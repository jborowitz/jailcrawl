...
ROW_INDEX = 818 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        close = browser.find_element_by_xpath('//*[@id="cmdCloseMessage"]')
        close.click()
        logger.info('clicked close on warning message')
