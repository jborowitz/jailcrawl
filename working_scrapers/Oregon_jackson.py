...
ROW_INDEX = 810 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        OLD URL: http://jacksoncountyor.org/sheriff/Jail/Current-Inmate-List
        UPDATED URL: https://inmate.jacksoncounty.org/
        """
        ...
        pages[letters[0]] = store_source
        logger.info('found page _%s_', letters[0])

        #Template for nex page
        xpath_template = '//*[@id="ucHeaderMenu_Menu1n{}"]/table/tbody/tr/td/a'
        
        for letter in letters[1:]:
            nextpage = browser.find_element_by_link_text(letter)
            nextpage.click()
            ...
            logger.info('found page _%s_', letter)
