...
ROW_INDEX = 707 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        listbox = browser.find_element_by_xpath('/html/body/form/table/tbody/tr[2]/td/table/tbody/tr/td[2]/div/div[2]/div[2]/div/div[5]/div/table/tbody/tr/td[2]/table/tbody/tr/td[5]/select')
        listbox.click()
        listbox.send_keys('All', Keys.RETURN)
