...
ROW_INDEX = 760 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        """
        Some TOR circuits do not work for this site; sometimes,
        the IP is blacklisted. Multiple attempts may be necessary.
        
        OLD URL: http://morrowcountysheriff.com/correctional-facility/
        DIRECT URL: http://www.jdsinc.net/ohmorrow/
        """
