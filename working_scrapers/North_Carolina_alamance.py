...
ROW_INDEX = 684 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        menu = browser.find_element_by_xpath('//*[@id="pager_center"]/table/tbody/tr/td[5]/select')
        menu.send_keys('All')
