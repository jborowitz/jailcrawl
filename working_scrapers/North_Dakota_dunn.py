...
ROW_INDEX = 720 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        pdf_link = soup.find_all('a', text=re.compile(".*Current Inmate Listing.*"))
        prefix = 'https://www.co.dunn.wi.us'
        suffix = pdf_link[0]['href']
