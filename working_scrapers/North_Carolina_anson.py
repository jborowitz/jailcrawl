...
ROW_INDEX = 686 # Change this for each scraper. This references the row
...
def main(roster_row):
    try:
        ...
        #show = browser.find_element_by_xpath('//*[@id="gvInmates_DXPagerBottom_DDB"]')
        show = browser.find_element_by_xpath('//*[@id="gvInmates_DXPagerBottom_PSI"]')
        show.click()
        
        time.sleep(np.random.uniform(10,15,1))
        
        show_all = browser.find_element_by_xpath('//*[@id="gvInmates_DXPagerBottom_PSP_DXI5_T"]/span')
        #show_all = browser.find_element_by_xpath('//*[@id="gvInmates_DXPagerBottom_PSP_DXI5_T"]')
        #show_all = browser.find_element_by_xpath('//*[@id="gvInmates_DXPagerBottom_PSP_DXI5_"]')
        show_all.click()
